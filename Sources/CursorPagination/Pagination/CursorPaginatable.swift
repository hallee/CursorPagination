...
public protocol CursorPaginatable: Model {
    static var defaultPageSizeCursor: Int { get }
    static var maxPageSizeCursor: Int? { get }
...
extension CursorPaginatable {
    ...
    public static var defaultPageSizeCursor: Int {
        return 10
    }

    public static var maxPageSizeCursor: Int? {
        return nil
    }
